...
class MealsData {
  final List<Meal> _loadedMeals = [
    ...
    Meal(
      ...
      price: 19.99,
      imageUrl:
          'https://www.crunchycreamysweet.com/wp-content/uploads/2018/11/classic-sweet-potato-casserole-2.jpg',
      ratings: 3.5,
      reviews: 123,
      timeToPrep: 30,
      vendorInfo: null,
    ...
    Meal(
      ...
      price: 49.99,
      imageUrl:
          'https://images.immediate.co.uk/production/volatile/sites/30/2020/08/spaghetti-puttanesca_1-1ce4e81.jpg?quality=90&resize=560,472',
      ratings: 4.0,
      reviews: 86,
      timeToPrep: 15,
      vendorInfo: null,
    ...
    Meal(
      ...
      price: 39.99,
      imageUrl:
          'https://juliasalbum.com/wp-content/uploads/2016/10/winter-fruit-salad-with-maple-lime-dressing.jpg',
      ratings: 4.0,
      reviews: 573,
      timeToPrep: 10,
      vendorInfo: null,
